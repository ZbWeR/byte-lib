...
/** Ported from `FluidCursor.vue`. WebGL fluid sim is kept, only the Vue lifecycle is React. */
  ...
  useEffect(() => {
    ...
    function initFramebuffers() {
      ...
      if (!rgba || !rg || !r) {
        ...
        console.error(
          "WebGL formats not supported, cannot initialize framebuffers"
        )
        return
      }
    ...
    // Mount-time init, same as the original Vue onMounted.
