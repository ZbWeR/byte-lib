  ...
  return (
    ...
    >
      <Link
        ...
        className="relative flex h-full w-full animate-in flex-col overflow-hidden rounded-2xl bg-white px-5 py-5 text-left duration-500 fade-in-0 outline-none [animation-fill-mode:backwards] slide-in-from-bottom-3 focus-visible:ring-2 focus-visible:ring-ring dark:bg-card"
      >
