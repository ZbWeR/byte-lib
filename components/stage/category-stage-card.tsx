  ...
  return (
    ...
    >
      <Link
        ...
        className="relative flex min-h-full w-full animate-in flex-col rounded-2xl border border-border bg-white px-5 py-5 text-left duration-500 fade-in-0 outline-none [animation-fill-mode:backwards] slide-in-from-bottom-3 focus-visible:ring-2 focus-visible:ring-ring dark:bg-card"
      >
